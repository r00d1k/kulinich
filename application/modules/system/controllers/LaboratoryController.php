<?php
class System_LaboratoryController extends Core_Controller_Action_Scaffold
{
    /** @var System_Model_Mapper_Photo  */
    protected $_mapper = 'System_Model_Mapper_Photo';
    protected $_captions = array(
        'index' => 'navigation-contents:lab',
        'create' => 'navigation:lab-add-photo',
        'edit'   => 'navigation:lab-edit-photo'
    );

    public function indexAction()
    {
        $req    = $this->_mapper->getDataRequest();
        $req->where('gallery', 'lab');
    ...
    public function createAction()
    {
        ...
        if($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()))
        {
            ...
            $model->gallery = 'lab';
            $model->rank = $this->_mapper->getCount(array('gallery'=> 'lab'));
            $model->save();
            $this->_actionSuccess(
