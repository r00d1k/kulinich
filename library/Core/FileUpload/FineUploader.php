<?php
class Core_FileUpload_FineUploader
{
    ...
    public function handleUpload($uploadDirectory, $name = null)
    {
        ...
        if($this->toBytes(ini_get('post_max_size')) < $this->sizeLimit || $this->toBytes(
        ...
        if($totalParts > 1)
        {
            ...
            if($success AND ($totalParts - 1 == $partIndex))
            {
                ...
                return array("success" => true, 'resultFile' => $name);
